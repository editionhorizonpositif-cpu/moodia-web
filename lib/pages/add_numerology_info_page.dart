// lib/screens/numerology/add_numerology_info_page.dart
import 'dart:async';
...
class AddNumerologyInfoPage extends StatefulWidget {
  const AddNumerologyInfoPage({super.key});

  @override
  State<AddNumerologyInfoPage> createState() => _AddNumerologyInfoPageState();
}

class _AddNumerologyInfoPageState extends State<AddNumerologyInfoPage>
  ...
  Future<void> _loadExistingData() async {
    try {
      ...
      final savedDate = prefs.getString('numerology_birthDate');

      if (savedName != null && savedDate != null) {
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      // Générer le profil via API
      final apiService = ApiService();
      final numerologyApiService = NumerologyApiService(apiService);

      await numerologyApiService.generateProfile(
        userId: userId,
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text(
            'Révélez l\'harmonie cosmique qui sommeille en vous à travers la vibration sacrée des nombres',
            style: TextStyle(
              fontSize: 16,
        ...
        Wrap(
          spacing: 12,
          children: [
            _buildSacredBadge('✨', 'SAGESSE'),
            _buildSacredBadge('🔮', 'INTUITION'),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            color: const Color(0xFF5D8CAE).withOpacity(0.3),
            blurRadius: 30,
  ...
  Widget _buildSacredFooter() {
    return Column(
      children: [
        ...
        Text(
          'La sagesse des nombres guide votre chemin',
          style: TextStyle(
            fontSize: 12,
...
// ========== DIALOGUE D'INFORMATION SUBLIME ==========
...
class _InfoDialog extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildInfoItemSacred(
                    '🔮 Chemin de Vie',
                    'Votre mission d\'âme et leçon principale',
                    const Color(0xFF8B6B9E),
                  ),
                  const SizedBox(height: 16),
                  _buildInfoItemSacred(
                    '📝 Expression',
                    'Vos talents innés et potentiel d\'incarnation',
                    const Color(0xFF5D8CAE),
                  ),
                  const SizedBox(height: 16),
                  _buildInfoItemSacred(
                    '🏆 Réalisation',
                    'Vos accomplissements futurs',
            ...
            Container(
              ...
              child: const Text(
                'Ces calculs ancestraux, basés sur la réduction théosophique et l\'attribution pythagoricienne, révèlent votre carte d\'identité vibratoire unique.',
                style: TextStyle(
                  fontSize: 14,
  ...
  Widget _buildInfoItemSacred(String title, String description, Color color) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
