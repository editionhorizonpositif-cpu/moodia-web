// lib/pages/challenge_search_page.dart
...
class ChallengeSearchPage extends StatefulWidget {
  const ChallengeSearchPage({super.key});

  @override
  State<ChallengeSearchPage> createState() => _ChallengeSearchPageState();
}
...
class _ChallengeSearchPageState extends State<ChallengeSearchPage> {
  ...
  Future<void> _loadDefaultChallenges() async { ... }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Nous améliorons l’expérience de recherche pour vous aider à trouver les défis qui vous correspondent. Revenez bientôt !',
                  style: TextStyle(
                    fontSize: 16,
