// lib/pages/challenge_join_page.dart
...
class ChallengeJoinPage extends StatefulWidget {
  final int challengeId;

  const ChallengeJoinPage({super.key, required this.challengeId});

  @override
  State<ChallengeJoinPage> createState() => _ChallengeJoinPageState();
}

class _ChallengeJoinPageState extends State<ChallengeJoinPage>
  ...
  Future<void> _loadChallenge() async {
    ...
    await provider.loadChallengeById(widget.challengeId);
  }
  ...
  Future<void> _handleJoin() async {
    if (!_acceptTerms) {
      ...
      _showErrorSnackBar('Veuillez accepter les conditions pour continuer');
      return;
    }
  ...
  Widget _buildRewardsSection(Challenge challenge) { ... }
  Widget _buildEngagementSection(Challenge challenge) { ... }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  'Nous améliorons l\'expérience d\'inscription aux défis. Revenez bientôt pour découvrir de nouvelles fonctionnalités !',
                  style: TextStyle(
                    fontSize: 16,
